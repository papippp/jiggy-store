...
export default function ProfileMianBody() {
    const orders = [
        ...
        { id: 7, name: 'Jiggy Viscor Cap', description: 'bbc logo curved ', amount: 70, pic: 'https://res.cloudinary.com/dqcztgs4v/image/upload/WhatsApp_Image_2024-11-25_at_5.44.07_PM_hdv0pk.jpg' },
        { id: 8, name: 'top boy boot ', description: 'Jiggy topboy jean', amount: 200, pic: 'https://res.cloudinary.com/dqcztgs4v/image/upload/WhatsApp_Image_2024-11-25_at_5.44.07_PM_hdv0pk.jpg' }
